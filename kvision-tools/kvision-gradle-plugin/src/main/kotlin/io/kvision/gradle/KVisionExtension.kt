...
abstract class KVisionExtension @Inject constructor(
    ...
    abstract class Versions @Inject constructor(
        ...
        val webpackDevServer: Property<String> = objects.property<String>().convention("4.15.0")

        @get:Optional
        /** Requires [KVisionExtension.enableWebpackVersions] to be true */
        val webpack: Property<String> = objects.property<String>().convention("5.85.0")

        @get:Optional
        /** Requires [KVisionExtension.enableWebpackVersions] to be true */
        val webpackCli: Property<String> = objects.property<String>().convention("5.1.1")
